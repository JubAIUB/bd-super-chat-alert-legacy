 ...
 *   payment    — Payment to merchant, bill pay
...
public class SmsParser {
    ...
    private static String classifyType(String provider, String body) {
        ...
        if ("bKash".equals(provider)) {
            ...
            // Payment: "Payment of Tk X to ..." or "Payment Tk X to ..."
            ...
            // Must check AFTER remittance/deposit/loan to avoid false matches
    ...
    private static String detectProvider(String sender, String body) {
        ...
        if (senderLower.contains("bkash") || senderLower.equals("16247") || bodyLower.contains("bkash"))
            return "bKash";
        if (senderLower.contains("nagad") || senderLower.equals("16167") || bodyLower.contains("nagad"))
            return "Nagad";

        // Fallback: detect from message patterns
        if (bodyLower.contains("trxid")) return "bKash";
        if (bodyLower.contains("txnid")) return "Nagad";
